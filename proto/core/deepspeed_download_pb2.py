...
_PREPAREDOWNLOADREQUEST = DESCRIPTOR.message_types_by_name['PrepareDownloadRequest']
_PREPAREDOWNLOADRESPONSE = DESCRIPTOR.message_types_by_name['PrepareDownloadResponse']
_DSDOWNLOADREQUEST = DESCRIPTOR.message_types_by_name['DsDownloadRequest']
_DSDOWNLOADRESPONSE = DESCRIPTOR.message_types_by_name['DsDownloadResponse']
_DSDOWNLOADSPLITRESPONSE = DESCRIPTOR.message_types_by_name['DsDownloadSplitResponse']
...
_DSDOWNLOADSERVICE = DESCRIPTOR.services_by_name['DsDownloadService']
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _PREPAREDOWNLOADREQUEST._serialized_start=121
  _PREPAREDOWNLOADREQUEST._serialized_end=294
  _PREPAREDOWNLOADRESPONSE._serialized_start=296
  _PREPAREDOWNLOADRESPONSE._serialized_end=358
  _DSDOWNLOADREQUEST._serialized_start=361
  _DSDOWNLOADREQUEST._serialized_end=529
  _DSDOWNLOADRESPONSE._serialized_start=531
  _DSDOWNLOADRESPONSE._serialized_end=646
  _DSDOWNLOADSPLITRESPONSE._serialized_start=648
  _DSDOWNLOADSPLITRESPONSE._serialized_end=701
  _DSDOWNLOADSERVICE._serialized_start=704
  _DSDOWNLOADSERVICE._serialized_end=965
