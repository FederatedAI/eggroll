...
_COMMANDREQUEST_KWARGSENTRY = _descriptor.Descriptor(
    ...
    fields=[
      _descriptor.FieldDescriptor(
          name='key',
          full_name='com.webank.eggroll.core.command.CommandRequest.KwargsEntry.key',
          index=0,
      ...
      _descriptor.FieldDescriptor(
          name='value',
          full_name='com.webank.eggroll.core.command.CommandRequest.KwargsEntry.value',
          index=1,
...
_COMMANDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
      _descriptor.FieldDescriptor(
          name='seq',
          full_name='com.webank.eggroll.core.command.CommandRequest.seq',
          index=0,
      ...
      _descriptor.FieldDescriptor(
          name='uri',
          full_name='com.webank.eggroll.core.command.CommandRequest.uri',
          index=1,
      ...
      _descriptor.FieldDescriptor(
          name='args',
          full_name='com.webank.eggroll.core.command.CommandRequest.args',
          index=2,
      ...
      _descriptor.FieldDescriptor(
          name='kwargs',
          full_name='com.webank.eggroll.core.command.CommandRequest.kwargs',
          index=3,
...
_COMMANDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
      _descriptor.FieldDescriptor(
          name='seq',
          full_name='com.webank.eggroll.core.command.CommandResponse.seq',
          index=0,
          number=1, type=3, cpp_type=2, label=1,
          has_default_value=False, default_value=0,
          message_type=None, enum_type=None, containing_type=None,
      ...
      _descriptor.FieldDescriptor(
          name='request',
          full_name='com.webank.eggroll.core.command.CommandResponse.request',
          index=1,
      ...
      _descriptor.FieldDescriptor(
          name='data',
          full_name='com.webank.eggroll.core.command.CommandResponse.data',
          index=2,
...
_COMMANDREQUEST.fields_by_name[
  'kwargs'].message_type = _COMMANDREQUEST_KWARGSENTRY
...
CommandRequest = _reflection.GeneratedProtocolMessageType('CommandRequest',
                                                          (_message.Message,), {
...
CommandResponse = _reflection.GeneratedProtocolMessageType('CommandResponse',
                                                           (_message.Message,),
                                                           {
