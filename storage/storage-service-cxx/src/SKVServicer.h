...
#ifndef STORAGE_SERVICE_CXX_SKVSERVICER_H
#define STORAGE_SERVICE_CXX_SKVSERVICER_H
...
class SKVServicer final : public KVService::Service {
public:
    SKVServicer();
    SKVServicer(std::string dataDir);
    virtual ~SKVServicer() override ;
...
private:
    shared_ptr<SKVStore> getStore(ServerContext* context);

    string dataDir;
};


#endif //STORAGE_SERVICE_CXX_SKVSERVICER_H
