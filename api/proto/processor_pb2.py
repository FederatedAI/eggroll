...
ProcessConf = _reflection.GeneratedProtocolMessageType('ProcessConf', (_message.Message,), {
...
UnaryProcess = _reflection.GeneratedProtocolMessageType('UnaryProcess', (_message.Message,), {
...
BinaryProcess = _reflection.GeneratedProtocolMessageType('BinaryProcess', (_message.Message,), {
...
_PROCESSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='mapPartitions2',
    full_name='com.webank.ai.eggroll.api.computing.processor.ProcessService.mapPartitions2',
    index=5,
    containing_service=None,
    input_type=_UNARYPROCESS,
    output_type=storage__basic__pb2._STORAGELOCATOR,
