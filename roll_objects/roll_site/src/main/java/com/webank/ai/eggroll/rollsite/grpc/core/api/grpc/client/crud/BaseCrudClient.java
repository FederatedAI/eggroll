...
package com.webank.ai.eggroll.rollsite.grpc.core.api.grpc.client.crud;


import com.webank.ai.eggroll.api.core.BasicMeta;
import com.webank.ai.eggroll.api.core.BasicMeta.CallResponse;
import com.webank.ai.eggroll.rollsite.grpc.core.factory.CallMetaModelFactory;
import com.webank.ai.eggroll.rollsite.grpc.core.factory.GrpcStreamObserverFactory;
...
import com.webank.ai.eggroll.rollsite.grpc.core.utils.ReflectionUtils;
...
public abstract class BaseCrudClient<S> {
    ...
    protected Object doCrudRequest(Object model, CrudRequestProcessor crudRequestProcessor) {
        ...
        DelayedResult<CallResponse> delayedResult = new SingleDelayedResult<>();
