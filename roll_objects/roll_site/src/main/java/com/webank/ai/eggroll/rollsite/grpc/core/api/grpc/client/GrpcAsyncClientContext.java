...
package com.webank.ai.eggroll.rollsite.grpc.core.api.grpc.client;

import com.google.protobuf.Message;
import com.webank.ai.eggroll.api.core.BasicMeta;
import com.webank.ai.eggroll.rollsite.grpc.client.PushStreamProcessor;
import com.webank.ai.eggroll.rollsite.grpc.core.api.grpc.observer.BaseCallerResponseStreamObserver;
import com.webank.ai.eggroll.rollsite.grpc.core.error.handler.ExceptionHandler;
import com.webank.ai.eggroll.rollsite.grpc.core.factory.GrpcStubFactory;
...
public class GrpcAsyncClientContext<S extends AbstractStub, R extends Message, E extends Message> {
    ...
    public GrpcAsyncClientContext<S, R, E> setRequestStreamProcessorClassAndArguments(
        Class<PushStreamProcessor> streamProcessorClass, Object... constructorArguments) {
