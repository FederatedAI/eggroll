...
import eggroll.roll_site.rollsite.proto.basic_meta_pb2 as basic__meta__pb2
import eggroll.roll_site.rollsite.proto.proxy_pb2 as proxy__pb2
...
class DataTransferServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.push = channel.stream_unary(
        '/com.webank.eggroll.rollsite.networking.proxy.DataTransferService/push',
    ...
    self.pull = channel.unary_stream(
        '/com.webank.eggroll.rollsite.networking.proxy.DataTransferService/pull',
        request_serializer=proxy__pb2.Metadata.SerializeToString,
        response_deserializer=proxy__pb2.Packet.FromString,
        )
    self.unaryCall = channel.unary_unary(
        '/com.webank.eggroll.rollsite.networking.proxy.DataTransferService/unaryCall',
        request_serializer=proxy__pb2.Packet.SerializeToString,
        response_deserializer=proxy__pb2.Packet.FromString,
        )
...
def add_DataTransferServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'com.webank.eggroll.rollsite.networking.proxy.DataTransferService', rpc_method_handlers)
...
class RouteServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.query = channel.unary_unary(
        '/com.webank.eggroll.rollsite.networking.proxy.RouteService/query',
...
def add_RouteServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'com.webank.eggroll.rollsite.networking.proxy.RouteService', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
