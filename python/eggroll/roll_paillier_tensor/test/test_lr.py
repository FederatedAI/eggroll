...
class TestLR(unittest.TestCase):
  def test_lr(self):
    ...
    rp_x_G = rp_context.load('jianren', 'rp_x_G')
    rp_x_H = rp_context.load('jianren', 'rp_x_H')
    rp_x_Y = rp_context.load('jianren', 'rp_x_Y')
    ...
    while itr < max_iter:
      ...
      # enc_fore_grad_G.out(priv, "123333")
      enc_grad_G = (X_G * enc_fore_grad_G).mean(priv)
      enc_grad_G.out(priv, "xx430")
      print(enc_grad_G.__dict__)
      return
      # (X_G * enc_fore_grad_G).out(priv, "kkkkkkkkkkk")
      # # enc_grad_H = (X_H * enc_fore_grad_G).mean()
      #
      # (X_G * enc_fore_grad_G).out(priv, "0000000000")
      ...
      #
      # loss_A = loss_AA._store.get_all()[0][1]._ndarray
