...
public class RuntimeErConf extends ErConf {
    ...
    public RuntimeErConf(ErSessionMeta sessionMeta) {
        ...
        ErConf.getConf().put(MetaInfo.CONFKEY_SESSION_ID, sessionMeta.getId());
        ErConf.getConf().put(MetaInfo.CONFKEY_SESSION_NAME, sessionMeta.getName());
    }
    ...
    public RuntimeErConf(StartContainersRequest startContainersRequest) {
        ...
        ErConf.getConf().put(MetaInfo.CONFKEY_SESSION_ID, startContainersRequest.sessionId);
        ErConf.getConf().put(MetaInfo.CONFKEY_SESSION_NAME, startContainersRequest.name);
    }
