...
public class ApplicationStartedRunnerUtils {
    ...
    public static void run(Injector injector, String[] args) throws Exception {
        ...
        List<ApplicationStartedRunner> sortedList = listenerList.stream().sorted(Comparator.comparingInt(ApplicationStartedRunner::getSequenceId)).collect(Collectors.toList());
