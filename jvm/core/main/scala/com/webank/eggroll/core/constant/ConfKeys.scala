...
object RollSiteConfKeys {
  ...
  val EGGROLL_ROLLSITE_POLLING_AUTHENTICATION_USE_CONFIGURE = ErConfKey("eggroll.rollsite.polling.authentication.use.configure", false)
  val EGGROLL_ROLLSITE_POLLING_AUTHENTICATION_URI = ErConfKey("eggroll.rollsite.polling.authentication.uri", "/cloud-manager/api/site/rollsite/checkPartyId")
  ...
  val EGGROLL_ROLLSITE_POLLING_AUTHENTICATION_SIGNATER_GENERATOR = ErConfKey("eggroll.rollsite.polling.authentication.signature.generator", "com.webank.ai.fate.cloud.sdk.sdk.Fatecloud#generateSignature")
