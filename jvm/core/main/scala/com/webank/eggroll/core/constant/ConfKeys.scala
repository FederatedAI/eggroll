...
object RollSiteConfKeys {
  ...
  val EGGROLL_ROLLSITE_POLLING_PUSH_CONCURRENCY = ErConfKey("eggroll.rollsite.polling.push.concurrency", 3)
  val EGGROLL_ROLLSITE_POLLING_UNARYCALL_CONCURRENCY = ErConfKey("eggroll.rollsite.polling.unarycall.concurrency", 3)
