...
public class RetryException extends Exception {
  ...
  public RetryException(
      String message, int numberOfFailedAttempts, AttemptContext<?> lastFailedAttemptContext) {
    super(message,
        lastFailedAttemptContext == null ? null : lastFailedAttemptContext.getExceptionCause());
