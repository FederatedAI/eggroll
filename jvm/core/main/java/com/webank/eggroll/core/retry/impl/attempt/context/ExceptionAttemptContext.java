...
package com.webank.eggroll.core.retry.impl.attempt.context;
...
public final class ExceptionAttemptContext<T> implements AttemptContext<T> {
  ...
  public ExceptionAttemptContext(Throwable cause, int attemptCount,
      long elapsedTimeSinceFirstAttempt) {
  ...
  public T getResult() {
    throw new IllegalStateException(
        "The attempt resulted in an exception. There is no valid result");
  }
