...
@Component
@Scope("prototype")
public class MapPartitions2ServiceProcessor extends BaseProcessServiceProcessor<Processor.UnaryProcess, StorageBasic.StorageLocator> {
    public MapPartitions2ServiceProcessor(EggProcessServiceClient eggProcessServiceClient, Processor.UnaryProcess request, BasicMeta.Endpoint processorEndpoint) {
        super(eggProcessServiceClient, request, processorEndpoint);
    }

    @Override
    public StorageBasic.StorageLocator call() throws Exception {
        return eggProcessServiceClient.mapPartitions2(request, processorEndpoint);
    }
}
