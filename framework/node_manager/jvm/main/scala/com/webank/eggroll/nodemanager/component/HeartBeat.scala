...
import com.webank.eggroll.core.constant.{DeployConfKeys, ProcessorStatus, ProcessorTypes, SessionConfKeys}
import com.webank.eggroll.core.meta.ErProcessor

class HeartBeatService {
  def onProcessorHeartbeat(processor: ErProcessor): Unit = {
