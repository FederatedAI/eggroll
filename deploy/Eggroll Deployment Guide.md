...
| **eggroll.cluster.manager.host**                   | The host of ClusterManager               | Modify to designated ip of server.                           |
...
| coordinator                                        | The tag of rollsite                      | Use default value.                                           |
| **ip**                                             | The ip of rollsite server                | Modify to designated ip of rollsite server.                  |
| **port**                                           | The port of rollsite                     | Modify to designated port , such as 9370.                    |
| **partyId**                                        | The party id of this cluster             | Modify to designated value, different from other cluster,such as 10001, 10002 |
| route.table                                        | The path of route_table.json             | Use default value.                                           |
